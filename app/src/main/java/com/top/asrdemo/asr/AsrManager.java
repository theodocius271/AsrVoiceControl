...
public class AsrManager {
    ...
    public boolean initialize() {
        try {
            ...
            endpointConfig.setRule1(new EndpointRule(false, 1.5f, 0.0f)); // 1.0s trailing silence
            endpointConfig.setRule2(new EndpointRule(true, 1.0f, 0.0f)); // 0.9s with speech
